...
/**
 * Provides convenience methods for in-app com.android.vending.billing. You can
 * create one instance of this class for your application and use it to process
 * in-app com.android.vending.billing operations. It provides synchronous
 * (blocking) and asynchronous (non-blocking) methods for many common in-app
 * com.android.vending.billing operations, as well as automatic signature
 * verification.
 * <p>
 ...
 * ensure proper cleanup. This object holds a binding to the in-app
 * com.android.vending.billing service, which will leak unless you dispose of it
 * correctly. If you created the object on an Activity's onCreate method, then
 * the recommended place to dispose of it is the Activity's onDestroy method.
 * <p>
...
public class IabHelper {
     ...
     *                        in-app com.android.vending.billing service.
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    logDebug("In-app com.android.vending.billing version 3 supported for "
                            + packageName);
     ...
     * com.android.vending.billing. If you are calling {@link #launchPurchaseFlow}, then you must
    ...
    public boolean handleActivityResult(int requestCode, int resultCode,
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            // result code was OK, but in-app com.android.vending.billing
            // response was not OK.
            logDebug("Result code was OK but in-app com.android.vending.billing response was not OK: "
