...
import com.mytodokart.app.models.device_model.DeviceInfo;
...
//                Toast.makeText(context, "NetworkCallFailure : "+t, Toast.LENGTH_LONG).show();
    ...
    public void RequestOffers() {
        ...
        Call<OfferData> call = APIClient.getInstance()
                .getOffers(ConstantValues.LANGUAGE_ID);

        try {
            Response<OfferData> response = call.execute();
            OfferData offerData = new OfferData();
            if (response.isSuccessful()) {
                offerData = response.body();
                if (!TextUtils.isEmpty(offerData.getSuccess()))
                    app.setOffersList(offerData.getData());
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void RequestStaticPagesData() {
