...
import com.mytodokart.app.models.ratings.RatingDataList;
...
public class ProductDetails implements Parcelable {
    ...
    @SerializedName("products_zip_codes")
    @Expose
    private String products_zip_codes;
    ...
    public String getProducts_zip_codes() {
        return products_zip_codes;
    }

    public void setProducts_zip_codes(String zip_codes) {
        this.products_zip_codes = zip_codes;
    }
    ...
    public void writeToParcel(Parcel parcel_out, int flags) {
        ...
        parcel_out.writeString(products_subscription);
    ...
    protected ProductDetails(Parcel parcel_in) {
        ...
        this.products_subscription = parcel_in.readString();
