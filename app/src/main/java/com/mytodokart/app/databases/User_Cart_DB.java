package com.mytodokart.app.databases;
...
public class User_Cart_DB {
    ...
    public static final String CART_PRODUCT_BASE_PRICE = "product_base_price";
    ...
    //public static final String PRODUCTS_ZIP_CODES           = "products_zip_codes";
    ...
    public static final String CART_SUB_START_DATE = "cart_sub_start_date";
    public static final String CART_SUB_END_DATE = "cart_sub_end_date";
    public static final String CART_ITEM_SUBSCRIPTION = "cart_item_subscription";
    ...
    public static String createTableCart() {
        ...
        return "CREATE TABLE " + TABLE_CART +
                ...
                CART_ITEM_SUBSCRIPTION + " TEXT," +
                CART_PRODUCT_BASE_PRICE + " TEXT," +
                CART_SUB_START_DATE + " TEXT," +
                CART_SUB_END_DATE + " TEXT" +
                ")";
    }
    ...
    public void addCartItem(CartProduct cart) {
        ...
        productValues.put(CART_PRODUCT_BASE_PRICE, cart.getCustomersBasketProduct().getProductsBasePrice());
        ...
        //productValues.put(PRODUCTS_ZIP_CODES,                   cart.getCustomersBasketProduct().getProducts_zip_codes());
        ...
        productValues.put(CART_ITEM_SUBSCRIPTION, cart.getCustomersBasketProduct().getProducts_subscription());

        productValues.put(CART_SUB_START_DATE, cart.getCustomersBasketProduct().getSubscriptionStart());
        productValues.put(CART_SUB_END_DATE, cart.getCustomersBasketProduct().getSubscriptionEnd());
    ...
    public ArrayList<CartProduct> getCartItems() {
        ...
        Cursor cursor1 = db.rawQuery("SELECT * FROM " + TABLE_CART, null);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                product.setProductsBasePrice(cursor.getString(26));
                ...
                //Cursor Value
                product.setProducts_subscription(cursor.getString(25));
                //product.setProducts_zip_codes(cursor.getString(24));
    ...
    public int getCartProductQnt(int productId) {
        int qnt = 0;
        // get and open SQLiteDatabase Instance from static method of DB_Manager class
        SQLiteDatabase db = DB_Manager.getInstance().openDatabase();
        ...
        Cursor cursor = db.rawQuery("SELECT " + CART_PRODUCT_QUANTITY + " FROM " + TABLE_CART + " WHERE " + CART_PRODUCT_ID + "=" + productId, null);
    ...
    public void updateCartSubscriptionStartEndItem(CartProduct cart) {
        // get and open SQLiteDatabase Instance from static method of DB_Manager class
        db = DB_Manager.getInstance().openDatabase();

        ContentValues values = new ContentValues();

        values.put(CART_SUB_START_DATE, cart.getCustomersBasketProduct().getSubscriptionStart());
        values.put(CART_SUB_END_DATE, cart.getCustomersBasketProduct().getSubscriptionEnd());
    ...
    public void updateCartItem(String qnt, String price, String pid) {
        // get and open SQLiteDatabase Instance from static method of DB_Manager class
        db = DB_Manager.getInstance().openDatabase();

        ContentValues values = new ContentValues();

        values.put(CART_PRODUCT_QUANTITY, qnt);
        values.put(CART_PRODUCT_TOTAL_PRICE, price);

        db.update(TABLE_CART, values, CART_PRODUCT_ID + " = ?", new String[]{pid});
    ...
    public static void initCartInstance() {
        AppSettingsDetails cartInfoInstanceFromAppSettingDetails = ((App) App.getContext().getApplicationContext()).getAppSettingsDetails();
        final String pkg = App.getContext().getApplicationContext().getPackageName();
