...
public class Most_Liked extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // most_liked_recycler.setLayoutManager(new GridLayoutManager(getContext(), 2));
//        most_liked_recycler.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false));
        most_liked_recycler.setLayoutManager(new GridLayoutManager(getActivity(),2,GridLayoutManager.VERTICAL,false));
    ...
    public void RequestMostLikedProducts() {
        ...
        getAllProducts.setLimit(50);
        getAllProducts.setUser_zip(prefsManager.getUserZipcode());
        getAllProducts.setCurrencyCode(ConstantValues.CURRENCY_CODE);
        networkCall = APIClient.getInstance().getAllProducts(getAllProducts);
