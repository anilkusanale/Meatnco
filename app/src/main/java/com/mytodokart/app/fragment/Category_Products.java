...
import com.mytodokart.app.models.filter_model.get_filters.FilterDetails;
import com.mytodokart.app.models.product_model.GetAllProducts;
import com.mytodokart.app.customs.EndlessRecyclerViewScroll;
import com.mytodokart.app.adapters.ProductAdapter;
import com.mytodokart.app.customs.FilterDialog;
import com.mytodokart.app.models.filter_model.post_filters.PostFilterData;
...
public class Category_Products extends Fragment {
    ...
    private void addCategoryProducts(ProductData productData) {
        ...
        for (int i = 0; i < productData.getProductData().size(); i++) {
            ...
            if(productDetails.getProductsId()!=pid) {
                pid = productDetails.getProductsId();
                System.out.println("Product Name "+productDetails.getProductsName());
