...
import com.mytodokart.app.adapters.ProductAdapterRemovable;
  ...
  /*  public void invalidateProducts() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // noInternetDialog.show();
        ...
        productAdapter = new ProductAdapterRemovable(getContext(), recentViewedList, true, true, headerText, null,false);
        GridLayoutManager gridLayoutManager=new GridLayoutManager(getActivity(),2);
        gridLayoutManager.setOrientation(GridLayoutManager.VERTICAL);
        recents_recycler.setLayoutManager(gridLayoutManager);
    ...
    private void addRecentProducts(ProductData productData) {
       ...
       /* if (productData.getProductData().size() > 0 ) {
            recentViewedList.add(productData.getProductData());
        }*/
        recentViewedList = productData.getProductData();
        productAdapter = new ProductAdapterRemovable(getContext(), recentViewedList, true, true, headerText, null, false);
        GridLayoutManager gridLayoutManager=new GridLayoutManager(getActivity(),2);
        gridLayoutManager.setOrientation(GridLayoutManager.VERTICAL);
        recents_recycler.setLayoutManager(gridLayoutManager);
    ...
    public void RequestProductDetails() {
        ...
        getAllProducts.setLimit(5);
        Call<ProductData> call = APIClient.getInstance()
                .getNewProducts(getAllProducts);
