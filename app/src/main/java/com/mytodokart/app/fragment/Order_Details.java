...
import com.mytodokart.app.activities.Order_Tracking_Activity;
import com.mytodokart.app.adapters.CouponsAdapter;
import com.mytodokart.app.adapters.OrderedProductsListAdapter;
import com.mytodokart.app.constant.ConstantValues;
import com.mytodokart.app.models.coupons_model.CouponsInfo;
import com.mytodokart.app.models.order_model.OrderDetails;
import com.mytodokart.app.models.order_model.OrderProducts;
...
public class Order_Details extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        subTotal = subTotal-Double.parseDouble(orderDetails.getTotalTax());


        String orderPrice = new DecimalFormat("#0.00").format(Double.parseDouble(orderDetails.getOrderPrice())) + " " + ConstantValues.CURRENCY_SYMBOL;
        String Tax = new DecimalFormat("#0.00").format(Double.parseDouble(orderDetails.getTotalTax())) + " " + ConstantValues.CURRENCY_SYMBOL;
        String Shipping = new DecimalFormat("#0.00").format(Double.parseDouble(orderDetails.getShippingCost())) + " " + ConstantValues.CURRENCY_SYMBOL;
        String Discount = new DecimalFormat("#0.00").format(Double.parseDouble(orderDetails.getCouponAmount() + "")) + " " + ConstantValues.CURRENCY_SYMBOL;
        String Subtotal = new DecimalFormat("#0.00").format(subTotal) + " " + ConstantValues.CURRENCY_SYMBOL;
        String Total = new DecimalFormat("#0.00").format(Double.parseDouble(orderDetails.getOrderPrice())) + " " + ConstantValues.CURRENCY_SYMBOL;
        ...
        couponsAdapter = new CouponsAdapter(getContext(), couponsList, false, null, ConstantValues.CURRENCY_SYMBOL);
        ...
        orderedProductsAdapter = new OrderedProductsListAdapter(getContext(), orderProductsList, ConstantValues.CURRENCY_SYMBOL);
