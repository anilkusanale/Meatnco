...
import com.mytodokart.app.adapters.ProductReviewsAdapter;
...
import com.mytodokart.app.models.ratings.ProductReviews;
...
import com.mytodokart.app.adapters.ProductAttributesAdapter;
...
import com.mytodokart.app.models.product_model.Attribute;
import com.mytodokart.app.models.product_model.Image;
...
public class Product_Description extends Fragment {
    ...
    TextView title, category, price_new, price_old,itemWeight, product_stock, product_likes, product_tag_new, product_tag_discount,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.product_description1, container, false);
     ...
     //   ((MainActivity) getActivity()).toggleNavigaiton(false);
        ...
        itemWeight = (TextView) rootView.findViewById(R.id.itemWeight);
        ...
        if (productDetails.getProductsWeight()!=null) {
            itemWeight.setText(productDetails.getProductsWeight()+" "+productDetails.getProductsWeightUnit());
        }
    ...
    private void setProductDetails(final ProductDetails productDetails) {
        ...
        productOrPrice =  Double.parseDouble(productDetails.getProductsPrice());
        if (discount != null) {
        ...
        if(productDetails.getProducts_subscription().equalsIgnoreCase("1")){
            productCartBtn.setText("Subscribe");
        }
        ...
        String styleSheet = "<style> " + "body{background:#ffffff; margin:0; padding:0} " +
                "p{color:#757575;} " +
            ...
            public void onClick(View view) {
                if (productDetails.getProductsType() == 2) {
                    ...
                    if (productDetails.getProductsQuantity() > 0) {
                        ...
                        productDetails.setProductsBasePrice(String.valueOf(productOrPrice));
                        ...
                        if(productDetails.getProducts_subscription().equalsIgnoreCase("1")){
                            if(My_Cart.checkSubscribed("0")){
                                ...
                                productDetails.setProducts_subscription("1");
                                productDetails.setCustomersBasketQuantity(1);
                                productDetails.setTotalPrice(String.valueOf(productFinalPrice * 30));
                                cartProduct.setCustomersBasketProduct(productDetails);
                                //My_Cart.ClearCart();
