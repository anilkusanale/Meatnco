...
import com.mytodokart.app.adapters.AddressListAdapter;
...
public class My_Addresses extends Fragment implements AddressListAdapter.AddressListInterface {
    ...
    private void addAddresses(AddressData addressData) {
        ...
        for (int i = 0; i < addressData.getData().size(); i++) {
            if(!addressData.getData().get(i).getStreet().equalsIgnoreCase(street)) {
                street = addressData.getData().get(i).getStreet();
                System.out.println(street);
                addressesList.add(addressData.getData().get(i));
            }
        }
        ...
        addressListAdapter = new AddressListAdapter(My_Addresses.this, getContext(), customerID, defaultAddressPosition, addressesList, My_Addresses.this,this);
    ...
    public void RequestAllAddresses() {
        ...
        Call<AddressData> call = APIClient.getInstance().getAllAddress(customerID);
    ...
    public void MakeAddressDefault(final String customerID, final String addressID, final Context context, final View view) {
        ...
        Call<AddressData> call = APIClient.getInstance()
                .updateDefaultAddress(customerID, addressID);
