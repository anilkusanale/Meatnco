...
import com.mytodokart.app.fragment.SubCategories_4;
...
public class CategoryListAdapter_4 extends RecyclerView.Adapter<CategoryListAdapter_4.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Glide.with(context).load(ConstantValues.ECOMMERCE_URL+categoryDetails.getImage())
                .apply(options)
                .into(holder.category_image);

        if(holder.shimmerFrameLayout.isShimmerVisible())
        {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(final View itemView) {
            ...
            shimmerFrameLayout = itemView.findViewById(R.id.shimmerFrame);
