...
import com.mytodokart.app.fragment.Order_Details;
...
public class OrdersListAdapter extends RecyclerView.Adapter<OrdersListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.order_price.setText(new DecimalFormat("#0.00").format(Double.valueOf(orderDetails.getOrderPrice())) + " " + ConstantValues.CURRENCY_SYMBOL);
