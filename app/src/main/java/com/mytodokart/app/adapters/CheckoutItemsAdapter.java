...
public class CheckoutItemsAdapter extends RecyclerView.Adapter<CheckoutItemsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.checkout_item_size.setText(cartProduct.getCustomersBasketProduct().getProductsWeight()+" "+cartProduct.getCustomersBasketProduct().getProductsWeightUnit());
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView checkout_item_title, checkout_item_size, checkout_item_quantity, checkout_item_price, checkout_item_price_final, checkout_item_category;
        ...
        public MyViewHolder(final View itemView) {
            ...
            checkout_item_size = (TextView) itemView.findViewById(R.id.checkout_item_size);
