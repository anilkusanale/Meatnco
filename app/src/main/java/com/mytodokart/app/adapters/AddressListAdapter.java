...
import com.mytodokart.app.fragment.Add_Address;
...
public class AddressListAdapter extends RecyclerView.Adapter<AddressListAdapter.MyViewHolder> {
    ...
    AddressListInterface addressListInterface;
    ...
    public AddressListAdapter(My_Addresses my_addresses, Context context, String customerID, int defaultAddressPosition, List<AddressDetails> addressList, My_Addresses parentFrag,AddressListInterface addressListInterface) {
        ...
        this.addressListInterface=addressListInterface;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.delete_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addressListInterface.getposition(position);
            }
        });
        ...
        holder.edit_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (holder.makeDefault_rb.isChecked()) {
                    isAddressChecked=1;
                }
                else {
                    isAddressChecked=0;
                ...
                addressInfo.putString("addressLatitude", addressDetails.getLatitude());
                addressInfo.putString("addressLongitude", addressDetails.getLongitude());
                addressInfo.putInt("defaultAddress",isAddressChecked);
